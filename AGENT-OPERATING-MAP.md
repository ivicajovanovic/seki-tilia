...
- Review hashom zaključava input, props, design-direction, renderer, CSS, obe reference, sve rendere i finalni MP4. Svaka kasnija promena zahteva novo pokretanje `prepare-visual-review.mjs` i novi nezavisni pregled.
