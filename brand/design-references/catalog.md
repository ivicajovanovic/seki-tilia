...
| `ref-vertical-product-spotlight.png` | Snažna vertikalna skala proizvoda, slojevita kružna scenografija, prirodni akcenti i fokusiran lokacijski završetak. | Zaobljen strukturni footer, konkretne tvrdnje, proizvod, copy, kursor/UI artefakt, senke/zamućenja ili pravougaona podloga iza logoa. |
