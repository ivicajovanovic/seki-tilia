...
10. U Reels videu obezbediti neprekidnu vizuelnu dinamičnost u svakom sekundu: elementi ulaze fazno (eyebrow -> naslov -> offer pill -> produktna scena -> benefit ikone -> futer), a tokom faze zadržavanja primenjuje se blaga mikro-animacija (mikro-plutanje bočice, breath/pulse akcentne linije i gradijent drift) tako da video ni u jednom trenutku ne deluje statično. U završnom kadru videa (Reels closing scene), postolje/podijum se potpuno izostavlja i proizvod stoji čisto i samostalno sa desne strane, bez ikakvog podijuma ispod njega. Takođe, izbeći nepotrebna dupliranja istog teksta (npr. kada su CTA i oznaka ponude identični).
